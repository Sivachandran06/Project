...
const TaskCard = ({
    ...
    return(
        <div 
            className="bg-white rounded-xl py-4 shadow-md shadow-gray-400 border border-gray-200 cursor-pointer"
            onClick={onClick}
        >
            ...
            <div
             ...
             >
                ...
                <p className="text-xs text-gray-700/80 font-medium mt-2 mb-2 leading-[18px]">
