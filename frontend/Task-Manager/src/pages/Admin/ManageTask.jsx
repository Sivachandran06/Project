...
const ManageTask = ()=>{
    ...
    const getAllTasks = async()=>{
        ...
        try{
            ...
            const statsuSummary = response.data?.statsuSummary || {};

            const statusArray = [
                {label: "All", count: statsuSummary.all || 0},
                {label: "Pending", count: statsuSummary.pendingTasks || 0},
                {label: "In Progress", count: statsuSummary.inProgressTasks || 0},
                {label: "Completed", count: statsuSummary.completedTasks || 0}
            ];
